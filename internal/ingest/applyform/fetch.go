...
// because internal/ingest/sources imports THIS package (for the form its Recruitee adapter
...
// imported from internal/ingest/sources because the dependency runs the other way — sources
