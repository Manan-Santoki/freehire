...
export const FACET_ALIASES = {
  ...
  'devops': ['alkalmazás üzemeltető', 'alkalmazásüzemeltető', 'cloud analyst', 'cloud design engineer', 'cloud engineer', 'cloud migration engineer', 'cloud operations engineer', 'data center engineer', 'data center technician', 'database administrator', 'database engineer', 'devops', 'informatikai üzemeltető', 'infrastructure analyst', 'infrastructure engineer', 'infrastruktúra üzemeltető', 'it administrator', 'it infrastructure', 'it üzemeltető', 'linux administrator', 'linux systems engineer', 'ml ops', 'mlops', 'network operations engineer', 'oracle dba', 'platform engineer', 'platform engineering', 'release engineer', 'rendszergazda', 'rendszerüzemeltető', 'sap basis administrator', 'servicenow administrator', 'sharepoint administrator', 'sysadmin', 'system administrator', 'systems administrator', 'szoftverüzemeltető', 'windows administrator', 'администратор баз данных', 'девопс', 'системный администратор'],
  ...
  'network_engineering': ['hálózati mérnök', 'hálózati rendszermérnök', 'network administrator', 'network analyst', 'network design engineer', 'network engineer', 'network engineering', 'network specialist', 'network technician', 'сетевой администратор', 'сетевой инженер'],
  ...
  'qa': ['automata tesztelő', 'design engineer in test', 'manuális tesztelő', 'qa', 'quality assurance', 'sdet', 'software design engineer in test', 'szoftvertesztelő', 'test analyst', 'test automation', 'test engineer', 'tester', 'tesztmenedzser', 'тестирование', 'тестировщик'],
