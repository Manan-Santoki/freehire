...
export const FACET_ALIASES = {
  ...
  'healthcare': ['caregiver', 'cna', 'dental assistant', 'dental hygienist', 'home health aide', 'licensed practical nurse', 'lpn', 'medical assistant', 'medication technician', 'mri technologist', 'nurse', 'nurse practitioner', 'occupational therapist', 'optometrist', 'patient care technician', 'patient coordinator', 'pharmacy technician', 'phlebotomist', 'phlebotomy', 'physical therapist', 'physician', 'radiologic technologist', 'radiology technologist', 'registered nurse', 'rn', 'sonographer', 'surgical technician', 'veterinarian', 'veterinary technician', 'x-ray technician', 'x-ray technologist', 'xray technologist', 'ветеринарный врач', 'врач', 'медбрат', 'медсестра', 'санитар', 'фельдшер'],
  ...
  'ml_ai': ['ai/ml', 'computer vision engineer', 'deep learning', 'machine learning', 'machine learning engineer', 'ml developer', 'ml engineer', 'ml/ai', 'mlエンジニア', 'nlp engineer', '機械学習エンジニア'],
