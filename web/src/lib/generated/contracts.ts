...
export const FACET_ALIASES = {
  ...
  'security': ['appsec', 'blue team', 'ciso', 'cyber analyst', 'cyber security', 'cyber systems engineer', 'cybersecurity', 'devsecops', 'grc', 'iam', 'identity and access management', 'incident response', 'informatikai biztonsági', 'információ biztonsági', 'információbiztonsági', 'infosec', 'it auditor', 'it biztonsági', 'it-biztonsági', 'kiberbiztonsági', 'penetration tester', 'penetration testing', 'pentest', 'pentester', 'red team', 'red teamer', 'security', 'soc analyst', 'threat analyst', 'threat intel', 'threat intelligence', 'vulnerability analyst', 'vulnerability management', 'безопасности', 'безопасность', 'инженер по защите информации', 'кибербезопасность'],
