...
export const FACET_ALIASES = {
  ...
  'mobile': ['android', 'androidエンジニア', 'ios', 'iosエンジニア', 'mobilalkalmazás fejlesztő', 'mobilalkalmazás-fejlesztő', 'mobile', 'react native developer', 'мобильная', 'мобильный', 'мобильных', 'モバイルエンジニア'],
