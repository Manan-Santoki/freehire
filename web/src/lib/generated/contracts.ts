...
export const TALENT_FACET_PARAMS = ['categories', 'seniorities', 'skills', 'tz', 'cities', 'specializations'] as const;
export type TalentFacetParam = (typeof TALENT_FACET_PARAMS)[number];
...
export const SKILL_LABELS = {
  ...
  'near-miss-reporting': 'Near Miss Reporting',
  'neo4j': 'Neo4j',
  'nessus': 'Nessus',
  'nestjs': 'NestJS',
  'netsuite': 'NetSuite',
...
export const FACET_ALIASES = {
  'administration': ['admin assistant', 'administrative assistant', 'administrative coordinator', 'administrative specialist', 'data entry', 'executive assistant', 'front desk', 'legal secretary', 'medical secretary', 'office assistant', 'office manager', 'receptionist', 'secretary', 'virtual assistant', 'администратор', 'делопроизводитель', 'офис-менеджер', 'секретарь'],
  'ai_engineering': ['agent engineer', 'ai agent engineer', 'ai automation engineer', 'ai developer', 'ai engineer', 'ai product engineer', 'ai research engineer', 'ai software engineer', 'ai-automation engineer', 'ai-product engineer', 'ai-research engineer', 'applied ai', 'genai', 'generative ai', 'llm', 'llm engineer', 'prompt engineer', 'rag engineer'],
  'architecture': ['architect', 'cloud architect', 'enterprise architect', 'software architect', 'solutions architect', 'архитектор'],
  'backend': ['1c', '1с', 'back end', 'back-end', 'back-end developer', 'backend', 'backend developer', 'webアプリケーションエンジニア', 'webエンジニア', 'бекенд', 'бэкенд', 'アプリケーションエンジニア', 'サーバーサイドエンジニア', 'ソフトウェアエンジニア', 'バックエンドエンジニア'],
  'blockchain': ['blockchain', 'smart contract developer', 'web3 developer', 'блокчейн'],
  'business_analysis': ['1с аналитик', 'business analysis', 'business analyst', 'business process analyst', 'business system analyst', 'business systems analyst', 'functional analyst', 'it business analyst', 'process analyst', 'requirements analyst', 'system analyst', 'systems analyst', 'аналитик 1с', 'аналитик бизнес-процессов', 'аналитик требований', 'бизнес аналитик', 'бизнес-аналитик', 'системный аналитик'],
  ...
  'data_analytics': ['adatelemzési', 'adatelemző', 'analytics engineer', 'bi analyst', 'bi developer', 'bi fejlesztő', 'bi riportfejlesztő', 'bi-аналитик', 'business intelligence analyst', 'business intelligence developer', 'business intelligence engineer', 'data analyst', 'data analytics', 'data аналитик', 'power bi developer', 'tableau developer', 'аналитик bi', 'аналитик данных', 'データアナリスト'],
  'data_engineering': ['adattárház fejlesztő', 'data engineer', 'data engineering', 'data governance', 'data platform', 'data steward', 'etl developer', 'дата-инженер', 'инженер данных', 'データエンジニア'],
  'data_science': ['data scien', 'data science', 'data scientist', 'дата-сайентист', 'データサイエンティスト'],
  'design': ['design', 'design engineer, product', 'design system engineer', 'design systems engineer', 'designer', 'experience design engineer', 'game design engineer', 'product design engineer', 'service design engineer', 'ui', 'ui design engineer', 'ui/ux design engineer', 'ui/uxデザイナー', 'uiデザイナー', 'ux', 'ux design engineer', 'uxデザイナー', 'web design engineer', 'дизайн', 'дизайнер', 'プロダクトデザイナー'],
  ...
  'devops': ['alkalmazás üzemeltető', 'alkalmazásüzemeltető', 'cloud analyst', 'cloud design engineer', 'cloud engineer', 'cloud migration engineer', 'cloud operations engineer', 'data center engineer', 'data center technician', 'database administrator', 'database engineer', 'datenbankadministrator', 'devops', 'fachinformatiker', 'fachinformatiker für systemintegration', 'fachinformatiker systemintegration', 'informatikai üzemeltető', 'infrastructure analyst', 'infrastructure engineer', 'infrastruktúra üzemeltető', 'it administrator', 'it infrastructure', 'it systemelektroniker', 'it systemtechniker', 'it üzemeltető', 'it-systemelektroniker', 'it-systemtechniker', 'linux administrator', 'linux systems engineer', 'ml ops', 'mlops', 'network operations engineer', 'oracle dba', 'platform engineer', 'platform engineering', 'release engineer', 'rendszergazda', 'rendszerüzemeltető', 'sap basis administrator', 'servicenow administrator', 'sharepoint administrator', 'sysadmin', 'system administrator', 'systemadministrator', 'systems administrator', 'szoftverüzemeltető', 'windows administrator', 'администратор баз данных', 'девопс', 'системный администратор', 'インフラエンジニア', 'クラウドエンジニア', 'サーバーエンジニア', 'ネットワークエンジニア', 'ネットワーク設計構築エンジニア', 'プラットフォームエンジニア'],
  ...
  'frontend': ['angular developer', 'front end', 'front-end', 'front-end developer', 'frontend', 'frontend developer', 'react developer', 'react.js developer', 'reactjs developer', 'vue developer', 'vue.js developer', 'vuejs developer', 'фронт', 'фронтенд', 'フロントエンドエンジニア'],
  ...
  'healthcare': ['caregiver', 'cna', 'dental assistant', 'dental hygienist', 'drug safety', 'home health aide', 'licensed practical nurse', 'lpn', 'medical assistant', 'medication technician', 'mri technologist', 'nurse', 'nurse practitioner', 'occupational therapist', 'optometrist', 'patient care technician', 'patient coordinator', 'patient safety', 'pharmacy technician', 'phlebotomist', 'phlebotomy', 'physical therapist', 'physician', 'radiologic technologist', 'radiology technologist', 'registered nurse', 'rn', 'sonographer', 'surgical technician', 'veterinarian', 'veterinary technician', 'x-ray technician', 'x-ray technologist', 'xray technologist', 'ветеринарный врач', 'врач', 'медбрат', 'медсестра', 'санитар', 'фельдшер'],
  ...
  'industrial_engineering': ['application engineer', 'applications engineer', 'automation engineer', 'building engineer', 'commissioning engineer', 'control engineer', 'controls engineer', 'environmental engineer', 'facilities engineer', 'field engineer', 'field service engineer', 'food safety', 'functional safety', 'geotechnical engineer', 'industrial engineer', 'instrumentation engineer', 'maintenance engineer', 'manufacturing engineer', 'planning engineer', 'plant engineer', 'process engineer', 'product safety', 'production engineer', 'project engineer', 'quality engineer', 'resident engineer', 'service engineer', 'site engineer', 'supplier quality engineer', 'validation engineer', 'инженер', 'технолог'],
  ...
  'legal': ['attorney', 'compliance analyst', 'compliance manager', 'compliance officer', 'contract administrator', 'contract manager', 'contracts administrator', 'contracts manager', 'corporate counsel', 'data privacy manager', 'data privacy officer', 'data protection officer', 'general counsel', 'immigration assistant', 'immigration case manager', 'immigration consultant', 'immigration paralegal', 'immigration specialist', 'lawyer', 'legal assistant', 'legal counsel', 'legal manager', 'paralegal', 'privacy officer', 'regulatory affairs', 'комплаенс', 'корпоративный юрист', 'юрисконсульт', 'юрист'],
  ...
  'management': ['engineering manager', 'manager', 'team manager', 'trust & safety director', 'trust & safety manager', 'trust and safety director', 'trust and safety manager', 'менеджер'],
  ...
  'ml_ai': ['ai safety', 'ai/ml', 'computer vision engineer', 'deep learning', 'machine learning', 'machine learning engineer', 'ml developer', 'ml engineer', 'ml/ai', 'mlエンジニア', 'nlp engineer', '機械学習エンジニア'],
  'mobile': ['android', 'androidエンジニア', 'ios', 'iosエンジニア', 'mobilalkalmazás fejlesztő', 'mobilalkalmazás-fejlesztő', 'mobile app', 'mobile application', 'mobile applications', 'mobile apps', 'mobile architect', 'mobile automation', 'mobile developer', 'mobile engineer', 'mobile platform', 'mobile qa', 'mobile software', 'react native developer', 'xamarin', 'мобильная разработка', 'мобильное приложение', 'мобильной разработки', 'мобильный разработчик', 'мобильных приложений', 'モバイルエンジニア'],
  'network_engineering': ['hálózati mérnök', 'hálózati rendszermérnök', 'network administrator', 'network analyst', 'network design engineer', 'network engineer', 'network engineering', 'network specialist', 'network technician', 'netzwerkadministrator', 'netzwerktechniker', 'сетевой администратор', 'сетевой инженер'],
  'occupational_safety': ['director of safety', 'ehs', 'head of safety', 'health & safety', 'health and safety', 'hse', 'hse risk', 'hseq', 'hsse', 'industrial hygiene', 'industrial hygienist', 'qhse', 'risk control consultant', 'safety & health officer', 'safety administrator', 'safety advisor', 'safety and health officer', 'safety coordinator', 'safety director', 'safety engineer', 'safety inspector', 'safety intern', 'safety lead', 'safety manager', 'safety officer', 'safety professional', 'safety representative', 'safety risk', 'safety specialist', 'safety supervisor', 'safety technician', 'safety trainer', 'she advisor', 'she coordinator', 'she manager', 'she officer', 'she specialist', 'sheq', 'shes', 'workplace safety & health', 'workplace safety and health', 'охрана труда', 'охране труда', 'охраны труда'],
  ...
  'qa': ['automata tesztelő', 'design engineer in test', 'manuális tesztelő', 'qa', 'qaエンジニア', 'quality assurance', 'sdet', 'software design engineer in test', 'softwaretester', 'szoftvertesztelő', 'test analyst', 'test automation', 'test engineer', 'tester', 'tesztmenedzser', 'тестирование', 'тестировщик'],
  ...
  'security': ['application security', 'appsec', 'blue team', 'ciso', 'cloud security', 'cyber analyst', 'cyber security', 'cyber systems engineer', 'cybersecurity', 'devsecops', 'grc', 'iam', 'identity and access management', 'incident response', 'informatikai biztonsági', 'information security', 'információ biztonsági', 'információbiztonsági', 'infosec', 'it auditor', 'it biztonsági', 'it security', 'it-biztonsági', 'kiberbiztonsági', 'network security', 'penetration tester', 'penetration testing', 'pentest', 'pentester', 'red team', 'red teamer', 'security analyst', 'security architect', 'security engineer', 'security operations', 'security researcher', 'soc analyst', 'threat analyst', 'threat intel', 'threat intelligence', 'vulnerability analyst', 'vulnerability management', 'безопасности', 'безопасность', 'инженер по защите информации', 'кибербезопасность', 'セキュリティエンジニア'],
  'senior': ['senior', 'sr', 'сеньор', 'синьор', 'старший'],
  'skilled_trades': ['alignment technicians', 'automotive mechanic', 'automotive mechanics', 'automotive technician', 'automotive technicians', 'carpenter', 'diesel technician', 'electrician', 'field service technician', 'hvac technician', 'installation technician', 'life safety', 'machinist', 'maintenance technician', 'mechanic', 'mechanics', 'millwright', 'plumber', 'service technician', 'service technicians', 'tire technicians', 'welder', 'маляр', 'механик', 'плотник', 'рабочий по благоустройству', 'рабочий по комплексному обслуживанию', 'сварщик', 'слесарь', 'электрик', 'электромеханик', 'электромонтер', 'электромонтёр', 'электросварщик'],
  'software_engineering': ['.net developer', '.net engineer', '.net fejlesztő', 'abap developer', 'abap engineer', 'abap entwickler', 'abap fejlesztő', 'adatbázis fejlesztő', 'ai native developer', 'ai native engineer', 'ai-native developer', 'ai-native engineer', 'alkalmazás fejlesztő', 'alkalmazásfejlesztő', 'anwendungsentwickler', 'app developer', 'app engineer', 'application analyst', 'application developer', 'applications analyst', 'c# developer', 'c# engineer', 'c# fejlesztő', 'c++ developer', 'c++ engineer', 'database developer', 'desarrollador de software', 'desarrollador java', 'desarrolladora de software', 'desarrolladora java', 'desenvolvedor de software', 'desenvolvedor java', 'desenvolvedora de software', 'desenvolvedora java', 'deweloper oprogramowania', 'dotnet developer', 'dotnet engineer', 'drupal developer', 'drupal engineer', 'dynamics 365 developer', 'développeur java', 'développeur salesforce', 'engenheira de software', 'engenheiro de software', 'entwickler software', 'erp developer', 'erp engineer', 'fachinformatiker anwendungsentwicklung', 'fachinformatiker für anwendungsentwicklung', 'founding developer', 'founding engineer', 'game developer', 'game engineer', 'go developer', 'go engineer', 'golang developer', 'golang engineer', 'ingegnere del software', 'ingegnere software', 'ingeniera de software', 'ingeniero de software', 'ingénieur logiciel', 'integration developer', 'integration engineer', 'inżynier oprogramowania', 'it analyst', 'it developer', 'it engineer', 'it systems developer', 'it systems engineer', 'java developer', 'java engineer', 'java entwickler', 'java fejlesztő', 'java fejlesztők', 'java-entwickler', 'javascript developer', 'javascript engineer', 'magento developer', 'magento engineer', 'mainframe developer', 'mainframe engineer', 'member of technical staff', 'member of the technical staff', 'mes developer', 'mes engineer', 'node developer', 'node engineer', 'node.js developer', 'node.js engineer', 'node.js fejlesztő', 'nodejs developer', 'nodejs engineer', 'odoo fejlesztő', 'odoo-fejlesztő', 'oracle developer', 'oracle engineer', 'pega fejlesztő', 'php developer', 'php engineer', 'php fejlesztő', 'programista .net', 'programista python', 'python developer', 'python engineer', 'python fejlesztő', 'rails developer', 'rails engineer', 'rpa developer', 'rpa engineer', 'ruby developer', 'ruby engineer', 'salesforce administrator', 'salesforce consultant', 'salesforce developer', 'salesforce engineer', 'sap developer', 'sap engineer', 'servicenow developer', 'servicenow engineer', 'sharepoint developer', 'sharepoint engineer', 'shopify developer', 'shopify engineer', 'software analyst', 'software developer', 'software development engineer', 'software engineer', 'software engineering', 'software entwickler', 'software mérnök', 'software systems developer', 'software systems engineer', 'software-entwickler', 'softwareentwickler', 'softwareingenieur', 'sviluppatore software', 'system developer', 'system engineer', 'systems developer', 'systems engineer', 'szoftver fejlesztő', 'szoftverfejlesztő', 'szoftvermérnök', 'technical analyst', 'technology analyst', 'typescript developer', 'typescript engineer', 'web developer', 'web engineer', 'webfejlesztő', 'wordpress developer', 'wordpress engineer', 'программист', 'разработчик'],
  ...
  'sre': ['site reliability', 'sre', 'sreエンジニア'],
  'staff': ['staff'],
