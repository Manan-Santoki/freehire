...
export const FACET_ALIASES = {
  ...
  'ml_ai': ['ai/ml', 'computer vision engineer', 'deep learning', 'machine learning', 'machine learning engineer', 'ml developer', 'ml engineer', 'ml/ai', 'nlp engineer'],
  ...
  'qa': ['automata tesztelő', 'design engineer in test', 'manuális tesztelő', 'qa', 'quality assurance', 'sdet', 'software design engineer in test', 'softwaretester', 'szoftvertesztelő', 'test analyst', 'test automation', 'test engineer', 'tester', 'tesztmenedzser', 'тестирование', 'тестировщик'],
